...
import { ServerRouter, UNSAFE_withComponentProps, Meta, Links, Outlet, Scripts, Link, useRouteLoaderData, useFetcher, useActionData, Form, data, redirect, useLoaderData, UNSAFE_withErrorBoundaryProps } from "react-router";
...
import { relations, eq, desc, count } from "drizzle-orm";
...
const styles = "/assets/tailwind-_XpCWV7V.css";
const links = () => [{
  rel: "stylesheet",
  href: styles
}];
...
function MobileNav() {
  return /* @__PURE__ */ jsx("nav", { className: "lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-around items-center h-16", children: [
    /* @__PURE__ */ jsxs(Link, { to: "/", className: "flex flex-col items-center py-2 text-blue-500", children: [
      /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" }) }),
      /* @__PURE__ */ jsx("span", { className: "text-xs mt-1", children: "Home" })
    ] }),
    /* @__PURE__ */ jsxs(Link, { to: "/explore", className: "flex flex-col items-center py-2 text-gray-700", children: [
      /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" }) }),
      /* @__PURE__ */ jsx("span", { className: "text-xs mt-1", children: "Search" })
    ] }),
    /* @__PURE__ */ jsxs(Link, { to: "/notifications", className: "flex flex-col items-center py-2 text-gray-700", children: [
      /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" }) }),
      /* @__PURE__ */ jsx("span", { className: "text-xs mt-1", children: "Alerts" })
    ] }),
    /* @__PURE__ */ jsxs(Link, { to: "/messages", className: "flex flex-col items-center py-2 text-gray-700", children: [
      /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" }) }),
      /* @__PURE__ */ jsx("span", { className: "text-xs mt-1", children: "Messages" })
    ] })
  ] }) });
}
  ...
  return /* @__PURE__ */ jsx("div", { className: "border-b border-gray-200 p-4 hover:bg-gray-50 transition-colors", children: /* @__PURE__ */ jsxs("div", { className: "flex space-x-3", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-center space-x-8", children: [
        ...
        /* @__PURE__ */ jsxs("button", { className: "flex items-center space-x-2 text-gray-500 hover:text-red-500 transition-colors", children: [
          /* @__PURE__ */ jsx("svg", { className: "h-5 w-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" }) }),
          /* @__PURE__ */ jsx("span", { className: "text-sm", children: "0" })
        ] }),
...
function TweetForm() {
  ...
  const handleSubmit = (e) => {
    ...
    if (content.trim() && !isOverLimit) {
      fetcher.submit(
        ...
        { method: "POST", action: "/api/tweets/create" }
      );
    }
  };
  ...
  return /* @__PURE__ */ jsx("div", { className: "border-b border-gray-200 p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex space-x-3", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
      ...
      fetcher.data?.error && /* @__PURE__ */ jsx("p", { className: "text-red-500 text-sm mt-2", children: fetcher.data.error })
    ] })
  ] }) });
}
function Timeline() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto", children: [
    ...
    tweets2.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 border-b border-gray-200", children: [
      ...
      /* @__PURE__ */ jsx("h3", { className: "mt-2 text-sm font-medium text-gray-900", children: "No tweets yet" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-500", children: "Be the first to tweet!" })
    ] }) : tweets2.map(({ tweet, user }) => /* @__PURE__ */ jsx(Tweet, { tweet: {
      id: tweet.id,
...
async function action$4({
  ...
  try {
    ...
    return redirect("/home", {
      headers: {
        "Set-Cookie": `auth-token=${token}; HttpOnly; Path=/; Max-Age=604800`
      }
    });
  } catch (error) {
    return data({
