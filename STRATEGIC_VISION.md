...
2. **Onboarding**: Simple signup with username, no email verification
3. **First Tweet**: User posts their first 140-character message
4. **Following**: Find and follow interesting accounts
5. **Engagement**: Like, retweet, and reply to others' tweets
6. **Daily Use**: Check timeline for chronological updates

### Posting Flow
1. User clicks "Tweet" button
2. Character counter shows 140/140 remaining
3. User types message (real-time character count)
4. Optional: Add hashtags or mentions
5. Click "Post" - immediate publish to timeline
6. Confirmation with timestamp

### Timeline Flow
1. User lands on home timeline
2. See reverse-chronological tweets from followed accounts
3. Infinite scroll for historical tweets
4. Click tweet for detailed view and replies
5. Engage via like, retweet, or reply
